...
易标投标工具箱上游仓库的源码与 Release 文件镜像

[![Upstream](https://img.shields.io/badge/upstream-FB208%2FOpenBidKit__Yibiao-181717?logo=github&logoColor=white)](https://github.com/FB208/OpenBidKit_Yibiao)
[![Branch](https://img.shields.io/badge/branch-main-2ea44f?logo=git&logoColor=white)](https://github.com/FB208/OpenBidKit_Yibiao/tree/main)
[![Sync](https://img.shields.io/github/actions/workflow/status/hopol/Yibiao-mirror/sync.yml?label=sync&logo=githubactions&logoColor=white)](https://github.com/hopol/Yibiao-mirror/actions/workflows/sync.yml)
[![Release](https://img.shields.io/github/actions/workflow/status/hopol/Yibiao-mirror/release.yml?label=release&logo=githubactions&logoColor=white)](https://github.com/hopol/Yibiao-mirror/actions/workflows/release.yml)
[![Mirror License](https://img.shields.io/badge/mirror-MIT-blue.svg)](LICENSE)

[上游仓库](https://github.com/FB208/OpenBidKit_Yibiao) · [镜像 Releases](https://github.com/hopol/Yibiao-mirror/releases) · [Actions](https://github.com/hopol/Yibiao-mirror/actions)
...
本仓库用于镜像 [`FB208/OpenBidKit_Yibiao`](https://github.com/FB208/OpenBidKit_Yibiao) 的源码和 GitHub Release 文件。

- 源码来自上游 `main` 分支，导出到 `upstream/`。
- Release 文件来自上游最新 GitHub Release，并重新发布到本仓库的 Releases。
- 本仓库不修改上游源码，不重新构建二进制文件，也不提供易标投标工具箱的官方支持。

> [!NOTE]
> 上游项目是易标投标工具箱的独立桌面客户端。功能说明、安装方式、更新内容和使用要求请以上游仓库为准。
...
```mermaid
flowchart LR
    A["上游仓库<br>FB208/OpenBidKit_Yibiao"] --> B["sync.yml<br>检查 main 分支"]
    B --> C{"上游提交是否变化"}
    C -->|"否"| D["结束"]
...
upstream_url=https://github.com/FB208/OpenBidKit_Yibiao
...
| `version` | 从 `client/package.json` 读取的 `version`。 |
...
```bash
git clone https://github.com/hopol/Yibiao-mirror.git
cd Yibiao-mirror
chmod +x sync.sh
./sync.sh
```
...
`upstream/` 中的文件来自上游项目，其许可证、第三方资源条款和使用限制请以上游仓库为准。

---

<div align="center">

本仓库只是镜像，不是易标投标工具箱官方仓库。
